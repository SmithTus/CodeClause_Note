...
if (isset($_GET['delete'])) {
 ...
 if(isset($_POST['submit'])){
        ...
        // make sql query
        $query = "INSERT INTO notes(user_id,title,note,time_in) VALUES('$session_id','$title','$note','$currentDateTime')";
  ...
  <section class="vbox">
    <header class="bg-dark dk header navbar navbar-fixed-top-xs">
      <div class="navbar-header aside-md">
        ...
        <a href="notebook.php" class="navbar-brand" data-toggle="fullscreen"><img src="images/logo.png" class="m-r-sm">S T Notebook</a>
                ...
                <section class="dropdown-menu on aside-md m-l-n">
                  <section class="panel bg-white">
                    ...
                    <div class="panel-body animated fadeInRight">
                      <p><a href="https://www.youtube.com/@smithtuscano4576" target="_blank" class="btn btn-sm btn-facebook"><i class="fa fa-fw fa-youtube"></i> Invite from Youtube</a></p>
                    </div>
                  </section>
                </section>
              </div>
                        ...
                        <div class="tab-pane active" id="activity">
                          <ul class="list-group no-radius m-b-none m-t-n-xxs list-group-lg no-border">
                            ...
                            <li class="list-group-item">
                                ...
                                <p><?php echo substr($note['note'], 0, 1000)?></p>
                      ...
                      <div class="wrapper">
                        ...
                        <section class="panel clearfix bg-info lter">
                          <div class="panel-body">
                            <a href="https://www.instagram.com/s_tuscanoo/" class="thumb pull-left m-r">
                              <img src="images/profile.jpg" class="img-circle">
                            </a>
                            <div class="clear">
                              <a href="https://www.instagram.com/s_tuscanoo/" class="text-info">@s_tuscano <i class="fa fa-instagram"></i></a>
                              <small class="block text-muted">89 Followers</small>
                              <a href="https://www.instagram.com/s_tuscanoo/" target="_blank" class="btn btn-xs btn-success m-t-xs">Do Follow</a>
                            </div>
                          </div>
                        </section>
                      </div>
