...
<body>
      ...
      <section class="panel panel-default bg-white m-t-lg">
        ...
        <form name="signin" method="post">
          <div class="panel-body wrapper-lg">
            ...
            <input name="email" type="email" placeholder="smithtuscano...@gmail.com" class="form-control input-lg">
          </div>
          <div class="form-group">
  ...
  <footer id="footer">
    <div class="text-center padder">
      <p>
        <small>Notebook | Web Application by Smith Tuscano<br>&copy; 2023</small>
      </p>
    </div>
  </footer>
  <!-- / footer -->
